...
MemRefDescriptortest::MemRefDescriptortest(Value descriptor)
...
MemRefDescriptortest MemRefDescriptortest::createundef(OpBuilder &builder, Location loc,
                                         Type descriptorType) {

  Value descriptor = builder.create<LLVM::UndefOp>(loc, descriptorType);
  return MemRefDescriptortest(descriptor);
}

/// Builds IR creating a MemRef descriptor that represents `type` and
/// populates it with static shape and stride information extracted from the
/// type.
MemRefDescriptortest
MemRefDescriptortest::createfromStaticShape(OpBuilder &builder, Location loc,
                                  const TypeConverter &typeConverter,
                                  MemRefType type, Value memory) {
  return createfromStaticShape(builder, loc, typeConverter, type, memory, memory);
}

MemRefDescriptortest MemRefDescriptortest::createfromStaticShape(
  ...
  auto descr = MemRefDescriptortest::createundef(builder, loc, convertedType);
...
Value MemRefDescriptortest::createallocatedPtr(OpBuilder &builder, Location loc) {
  return extractPtr(builder, loc, kAllocatedPtrPosInMemRefDescriptor);
}

/// Builds IR inserting the allocated pointer into the descriptor.
void MemRefDescriptortest::createsetAllocatedPtr(OpBuilder &builder, Location loc,
                                       Value ptr) {
  setPtr(builder, loc, kAllocatedPtrPosInMemRefDescriptor, ptr);
}

/// Builds IR extracting the aligned pointer from the descriptor.
Value MemRefDescriptortest::createalignedPtr(OpBuilder &builder, Location loc) {
  return extractPtr(builder, loc, kAlignedPtrPosInMemRefDescriptor);
}

/// Builds IR inserting the aligned pointer into the descriptor.
void MemRefDescriptortest::createsetAlignedPtr(OpBuilder &builder, Location loc,
                                     Value ptr) {
...
Value MemRefDescriptortest::createoffset(OpBuilder &builder, Location loc) {
  return builder.create<LLVM::ExtractValueOp>(loc, value,
                                              kOffsetPosInMemRefDescriptor);
}

/// Builds IR inserting the offset into the descriptor.
void MemRefDescriptortest::createsetOffset(OpBuilder &builder, Location loc,
                                 Value offset) {
...
/// Builds IR inserting the offset into the descriptor.
void MemRefDescriptortest::createsetConstantOffset(OpBuilder &builder, Location loc,
                                         uint64_t offset) {
...
Value MemRefDescriptortest::createsize(OpBuilder &builder, Location loc, unsigned pos) {
  return builder.create<LLVM::ExtractValueOp>(
      loc, value, ArrayRef<int64_t>({kSizePosInMemRefDescriptor, pos}));
}

Value MemRefDescriptortest::createsize(OpBuilder &builder, Location loc, Value pos,
                             int64_t rank) {
...
void MemRefDescriptortest::createsetSize(OpBuilder &builder, Location loc, unsigned pos,
                               Value size) {
  value = builder.create<LLVM::InsertValueOp>(
      loc, value, size, ArrayRef<int64_t>({kSizePosInMemRefDescriptor, pos}));
}

void MemRefDescriptortest::createsetConstantSize(OpBuilder &builder, Location loc,
...
Value MemRefDescriptortest::createstride(OpBuilder &builder, Location loc, unsigned pos) {
  return builder.create<LLVM::ExtractValueOp>(
      loc, value, ArrayRef<int64_t>({kStridePosInMemRefDescriptor, pos}));
}

/// Builds IR inserting the pos-th stride into the descriptor
void MemRefDescriptortest::createsetStride(OpBuilder &builder, Location loc, unsigned pos,
                                 Value stride) {
  value = builder.create<LLVM::InsertValueOp>(
      loc, value, stride,
...
void MemRefDescriptortest::createsetConstantStride(OpBuilder &builder, Location loc,
...
Value MemRefDescriptortest::createpack(OpBuilder &builder, Location loc,
                             const TypeConverter &converter,
                             MemRefType type, ValueRange values) {
  Type llvmType = converter.convertType(type);
  auto d = MemRefDescriptortest::createundef(builder, loc, llvmType);
...
void MemRefDescriptortest::createunpack(OpBuilder &builder, Location loc, Value packed,
                              MemRefType type,
                              SmallVectorImpl<Value> &results) {
  int64_t rank = type.getRank();
  results.reserve(results.size() + creategetNumUnpackedValues(type));

  MemRefDescriptortest d(packed);
...
/// `unpack`.
unsigned MemRefDescriptortest::creategetNumUnpackedValues(MemRefType type) {
...
MemRefDescriptorViewtest::MemRefDescriptorViewtest(ValueRange range)
    : rank((range.size() - kSizePosInMemRefDescriptor) / 2), elements(range) {}

Value MemRefDescriptorViewtest::createallocatedPtr() {
  return elements[kAllocatedPtrPosInMemRefDescriptor];
}

Value MemRefDescriptorViewtest::createalignedPtr() {
  return elements[kAlignedPtrPosInMemRefDescriptor];
}

Value MemRefDescriptorViewtest::createoffset() {
  return elements[kOffsetPosInMemRefDescriptor];
}

Value MemRefDescriptorViewtest::createsize(unsigned pos) {
  return elements[kSizePosInMemRefDescriptor + pos];
}

Value MemRefDescriptorViewtest::createstride(unsigned pos) {
...
/// Construct a helper for the given descriptor value.
UnrankedMemRefDescriptortest::UnrankedMemRefDescriptortest(Value descriptor)
    : StructBuilder(descriptor) {}

/// Builds IR creating an `undef` value of the descriptor type.
UnrankedMemRefDescriptortest UnrankedMemRefDescriptortest::createundef(OpBuilder &builder,
                                                         Location loc,
                                                         Type descriptorType) {
  Value descriptor = builder.create<LLVM::UndefOp>(loc, descriptorType);
  return UnrankedMemRefDescriptortest(descriptor);
}
Value UnrankedMemRefDescriptortest::createrank(OpBuilder &builder, Location loc) const {
  return extractPtr(builder, loc, kRankInUnrankedMemRefDescriptor);
}
void UnrankedMemRefDescriptortest::createsetRank(OpBuilder &builder, Location loc,
                                       Value v) {
  setPtr(builder, loc, kRankInUnrankedMemRefDescriptor, v);
}
Value UnrankedMemRefDescriptortest::creatememRefDescPtr(OpBuilder &builder,
                                              Location loc) const {
  return extractPtr(builder, loc, kPtrInUnrankedMemRefDescriptor);
}
void UnrankedMemRefDescriptortest::createsetMemRefDescPtr(OpBuilder &builder,
...
Value UnrankedMemRefDescriptortest::createpack(OpBuilder &builder, Location loc,
                                     const TypeConverter &converter,
                                     UnrankedMemRefType type,
                                     ValueRange values) {
  Type llvmType = converter.convertType(type);
  auto d = UnrankedMemRefDescriptortest::createundef(builder, loc, llvmType);
...
void UnrankedMemRefDescriptortest::createunpack(OpBuilder &builder, Location loc,
                                      Value packed,
                                      SmallVectorImpl<Value> &results) {
  UnrankedMemRefDescriptortest d(packed);
...
Value UnrankedMemRefDescriptortest::createallocatedPtr(
...
void UnrankedMemRefDescriptortest::createsetAllocatedPtr(
    OpBuilder &builder, Location loc, Value memRefDescPtr,
...
Value UnrankedMemRefDescriptortest::createalignedPtr(
    OpBuilder &builder, Location loc, const TypeConverter &typeConverter,
...
void UnrankedMemRefDescriptortest::createsetAlignedPtr(
    OpBuilder &builder, Location loc, const TypeConverter &typeConverter,
...
Value UnrankedMemRefDescriptortest::createoffsetBasePtr(
    OpBuilder &builder, Location loc, const TypeConverter &typeConverter,
    Value memRefDescPtr, LLVM::LLVMPointerType elemPtrType) {
  auto [elementPtrPtr, elemPtrPtrType] =
      castToElemPtrPtr(builder, loc, memRefDescPtr, elemPtrType);
...
void UnrankedMemRefDescriptortest::createsetOffset(OpBuilder &builder, Location loc,
                                         const TypeConverter &typeConverter,
                                         Value memRefDescPtr,
                                         LLVM::LLVMPointerType elemPtrType,
                                         Value offset) {
