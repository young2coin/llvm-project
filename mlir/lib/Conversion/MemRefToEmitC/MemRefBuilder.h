...
class MemRefDescriptortest : public StructBuilder {
public:
  /// Construct a helper for the given descriptor value.
  explicit MemRefDescriptortest(Value descriptor);
  /// Builds IR creating an `undef` value of the descriptor type.
  static MemRefDescriptortest createundef(OpBuilder &builder, Location loc,
                                Type descriptorType);
  /// Builds IR creating a MemRef descriptor that represents `type` and
  /// populates it with static shape and stride information extracted from the
  /// type.
  static MemRefDescriptortest
...
/// the values.
class MemRefDescriptorViewtest {
public:
  /// Constructs the view from a range of values. Infers the rank from the size
  /// of the range.
  explicit MemRefDescriptorViewtest(ValueRange range);
...
class UnrankedMemRefDescriptortest : public StructBuilder {
public:
  /// Construct a helper for the given descriptor value.
  explicit UnrankedMemRefDescriptortest(Value descriptor);
  /// Builds IR creating an `undef` value of the descriptor type.
  static UnrankedMemRefDescriptortest createundef(OpBuilder &builder, Location loc,
                                        Type descriptorType);
  ...
  static void computeSizes(OpBuilder &builder, Location loc,
                           ...
                           ArrayRef<UnrankedMemRefDescriptortest> values,
